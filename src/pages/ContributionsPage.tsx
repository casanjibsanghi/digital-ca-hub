...
const ContributionsPage = () => {
  ...
  const contributions = [
    // ICAI Leadership
    {
      ...
      file: '',
      achievements: [
        'Spearheading AI integration policies for the accounting profession',
        'Leading curriculum modernization committee',
        'Establishing international partnership frameworks'
      ]
    },
    {
      area: 'icai-leadership',
      ...
      file: '',
      achievements: [
        'Launched 15+ professional development programs',
        'Increased regional membership engagement by 40%',
        'Established digital service delivery framework'
      ]
    },
    {
      area: 'icai-leadership',
      ...
      file: '',
      achievements: [
        'Integrated technology modules in CA curriculum',
        'Developed online assessment frameworks',
        'Introduced practical AI training components'
      ]
    },
    ...
    // GCC Initiative
    {
      ...
      file: '',
      achievements: [
        'Mapped 200+ GCC opportunities across 15 countries',
        'Facilitated 500+ job placements',
    ...
    },
    {
      ...
      file: '',
      achievements: [
        'Signed MoUs with 8 international accounting institutes',
        'Established reciprocal recognition frameworks',
        'Created global mobility pathways for Indian CAs'
      ]
    },
    ...
    // Students & BoS
    {
      ...
      file: '',
      achievements: [
        'Mentored 1000+ CA students and professionals',
        'Achieved 85% mentorship completion rate',
        'Established 50+ mentor chapters across India'
      ]
    },
    {
      area: 'students-bos',
      ...
      file: '',
      achievements: [
        'Conducted 100+ workshops across 25 cities',
        'Reached 15,000+ students and professionals',
        'Developed comprehensive career planning toolkit'
      ]
    },
    ...
    // MSME & Start-ups
    {
      ...
      file: '',
      achievements: [
        'Developed standardized financial management frameworks',
        'Supported 500+ MSMEs with compliance and growth strategies',
        'Created digital tools for financial planning and analysis'
      ]
    },
    {
      area: 'msme-startups',
      ...
      file: '',
      achievements: [
        'Advised 200+ start-ups on financial structuring',
        'Facilitated $10M+ in funding connections',
        'Established start-up CA network with 300+ members'
      ]
    },
    ...
    // Digital Transformation
    {
      ...
      file: '',
      achievements: [
        'Published 15+ research papers on AI in accounting',
        'Developed AI-powered audit automation tools',
        'Established AI research center with IIT collaboration'
      ]
    },
    {
      area: 'digital-transformation',
      ...
      file: '',
      achievements: [
        'Built community of 10,000+ digital accounting professionals',
        'Organized 50+ digital transformation workshops',
        'Created comprehensive digital skills certification program'
      ]
    },
    ...
    // Publications/Tools
    {
      ...
      file: '',
      achievements: [
        'Sold 25,000+ copies across India and internationally',
        'Translated into 3 regional languages',
        'Adopted as reference text by 20+ CA training institutes'
      ]
    },
    {
      area: 'publications-tools',
      ...
      file: '',
      achievements: [
        'Downloaded by 50,000+ professionals',
        'Regular updates with latest industry trends',
        'Integrated with major CA learning platforms'
      ]
    },
  ];

  // Filter contributions based on selected area
  const filteredContributions = selectedArea === 'all' 
    ? contributions 
    : contributions.filter(contribution => contribution.area === selectedArea);
      ...
      <div className="container py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {contributionAreas.map((area) => (
            <Card 
              key={area.id} 
              className={`shadow-professional hover-lift cursor-pointer transition-all ${
                selectedArea === area.id ? 'ring-2 ring-gold' : ''
              }`}
        ...
        <Tabs value={selectedArea} onValueChange={setSelectedArea} className="mb-8">
          <TabsList className="grid w-full grid-cols-1 md:grid-cols-4 lg:grid-cols-7 h-auto">
            <TabsTrigger value="all" className="text-sm">All Areas</TabsTrigger>
            {contributionAreas.map((area) => (
                    ...
                    <CardHeader>
                      <div className="flex items-start justify-between mb-3">
                        <div className="flex items-center space-x-3">
                          {area && (
                            <div className={`w-10 h-10 rounded-full bg-muted flex items-center justify-center ${area.color}`}>
                        ...
                        <Badge className="bg-gold text-slate">
                          {area?.name}
                        </Badge>
                      </div>
                    </CardHeader>
