      ...
      <div className="container py-16">
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2">
              <Button
                ...
                className={selectedTag === '' ? 'bg-gold hover:bg-gold-light text-slate' : ''}
              >
                All Topics
              </Button>
              {allTags.map((tag) => (
                <Button
                  ...
                  className={selectedTag === tag ? 'bg-gold hover:bg-gold-light text-slate' : ''}
                >
                  {tag}
                </Button>
              ))}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredArticles.map((article) => (
            <Card key={article.id} className="shadow-professional hover-lift group overflow-hidden">
