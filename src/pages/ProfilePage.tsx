...
const ProfilePage = () => {
  const highlights = ['Council Member, ICAI (2025–29)', 'Member, GCC Advisory Committee, Ministry of Electronics and Information Technology (MeitY), GOI', 'Chairman, EIRC-ICAI (2024-25)', 'Co-authored "The Digital Professional"', 'Co-authored "MSME Shorts - From Inception to Success"', 'Chairman, Global Trade and Services Committee', 'Convenor, Continuing Professional Education Directorate', 'Vice Chairman, Sustainability Reporting Standards Board', 'Mentor to 1000+ students and professionals', 'Speaker at 50+ national and international conferences'];
  const socialLinks = [{
    icon: Linkedin,
    href: '#',
    label: 'LinkedIn',
            ...
            <Card className="shadow-professional hover-lift">
              <CardContent className="p-8 text-center">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  >
                    <a 
                      href="https://docs.google.com/document/d/1eyvda_jArIUi8-U84YyVRGWv_wMnyXKbW4YYfRiQztw/edit?tab=t.0" 
                      target="_blank" 
